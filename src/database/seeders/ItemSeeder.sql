...
VALUES (1, 1, 1, 'phone in a good condition', 'samsung phone'),                 /* wants 1 */
       (2, 1, 2, 'nice car', 'Tesla car'),
       (3, 1, 3, 'literally just a duck, don\'t ask', 'quacky duck'),            /* has 3 */
       (4, 3, 4, 'refrigerator to keep your condoms cool', 'cooler 3000'),      /* has 4 */
       (5, 1, 5, 'anti-baby matter, AKA condoms', 'magnum dong'),
       (6, 2, 1, 'phone in a good condition', 'samsung phone'),                 /* has 1 */
       (7, 2, 4, 'refrigerator to keep your condoms cool', 'cooler 3000'),      /* wants 4 */
       ...
       (15, 3, 3, 'literally just a duck, don\'t ask', 'quacky duck');              /* wants 3 */
