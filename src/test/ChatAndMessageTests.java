...
public class ChatAndMessageTests {
    ...
    public void chatAndMessageTest(){
        ...
        Message msg1 = new Message(ch1.getChatID(), 1,"first message");
        Message msg2 = new Message(ch1.getChatID(), 2,"second message");
        Message msg3 = new Message(ch2.getChatID(), 1,"third message");
